...
export default function PortfolioItem({ itemTitle, imageUrl, description, tech,  demoUrl, githubUrl }){
    return (
        <section className="portfolioItemWrapper">
            ...
            <section className="linkWrapper">
                ...
                <a href={githubUrl} className="linkButton">View frontend <img src={githubIcon} alt="githubIcon" className="linkIcon" /></a>
            </section>
        </section>
    )
}